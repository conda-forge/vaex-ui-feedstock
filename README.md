About vaex-ui-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vaex-ui-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3623&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vaex-ui-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vaex-ui` can be installed with `conda`:
...
```
mamba install vaex-ui
```

It is possible to list all of the versions of `vaex-ui` available on your platform with `conda`:
...
```
mamba search vaex-ui --channel conda-forge
```
...
mamba repoquery search vaex-ui --channel conda-forge

# List packages depending on `vaex-ui`:
mamba repoquery whoneeds vaex-ui --channel conda-forge

# List dependencies of `vaex-ui`:
mamba repoquery depends vaex-ui --channel conda-forge
```
